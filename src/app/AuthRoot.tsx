// Livello app: container che tiene lo stato di SESSIONE reale e rende AuthGate.
// A differenza di 1.6 (dove lo stato nasceva a `false`), qui la sessione è
// riflessa al boot: `isAuthenticated()` letta all'avvio e `onAuthStateChange`
// tiene lo stato in sincrono (AC3/FR1.3).
//
...
// AC3) — poi `authenticated` o `anonymous`.
//
